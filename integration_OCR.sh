...
rm -rf reports/*.*
npx cypress run  --spec cypress/e2e/OCR/OCR.cy.js  --config video=false,screenshotOnRunFailure=false --reporter junit --reporter-options "mochaFile=reports/TEST-[hash].xml"
